...
def generate_stories(num_stories, output_file='./training_data/llama-stories.md'):
    progress_count = 1
    ...
    with open(output_file, 'w', encoding="utf-8") as file:
        for _ in range(num_stories):
            ...
            user_prompt_response = prompt_ollama(user_prompt)
            full_story = user_prompt_response + "<start>" + story + "\n<end>"
