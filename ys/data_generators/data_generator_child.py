    ...
    while True:
        ...
        for name in main_characters:
            titles_string = prompt_ollama(
                f"Provide a comma delimited list of 20 titles for child-appropriate stories about a child named {name}. Do not use titles of real books or stories, invent new titles that don't exist. Do not make another other comments or acknowledgements.")
            print(f"Name: {name}")
